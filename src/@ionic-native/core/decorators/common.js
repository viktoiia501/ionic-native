...
exports.wrapInstance =
  ...
  exports.callCordovaPlugin =
  exports.setIndex =
  exports.instanceAvailability =
  exports.checkAvailability =
  exports.wrapPromise =
  exports.getPromise =
  exports.ERR_PLUGIN_NOT_INSTALLED =
  exports.ERR_CORDOVA_NOT_AVAILABLE =
    void 0;
var rxjs_1 = require('rxjs');
exports.ERR_CORDOVA_NOT_AVAILABLE = { error: 'cordova_not_available' };
exports.ERR_PLUGIN_NOT_INSTALLED = { error: 'plugin_not_installed' };
...
function wrapEventObservable(event, element) {
  ...
  return rxjs_1.fromEvent(element, event);
}
function checkAvailability(plugin, methodName, pluginName) {
  ...
  if (!pluginInstance || (!!methodName && typeof pluginInstance[methodName] === 'undefined')) {
    if (typeof window === 'undefined' || !window.cordova) {
      ...
      return exports.ERR_CORDOVA_NOT_AVAILABLE;
    }
    pluginWarn(pluginName, pluginPackage, methodName);
    return exports.ERR_PLUGIN_NOT_INSTALLED;
  }
  return true;
}
...
exports.callCordovaPlugin = callCordovaPlugin;
...
exports.cordovaWarn = cordovaWarn;
/**
 * @private
 */
